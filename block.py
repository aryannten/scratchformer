...
class FeedForward(nn.Module):
    """A simple linear layer followed by a non-linearity (GELU), projection back, and dropout."""
...
class TransformerBlock(nn.Module):
    ...
    def __init__(self, embed_dim: int, num_heads: int, block_size: int, dropout: float = 0.0):
        ...
        self.attn = MultiHeadAttention(embed_dim, num_heads, block_size, dropout=dropout)
